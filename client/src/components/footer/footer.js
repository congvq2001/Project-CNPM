...
export default function Footer() {
    ...
    <div>
       <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 border-top">
        <p className="col-md-4 mb-0 text-muted">© 20221 Copyright by Team 03 Software Engineering</p>   
        ...
        <div className='contact'>Contact: ĐHBKHN, Số 1 Đại Cồ Việt - Hà Nội - Vietnam</div>
      </footer>
    </div>
    )
}
